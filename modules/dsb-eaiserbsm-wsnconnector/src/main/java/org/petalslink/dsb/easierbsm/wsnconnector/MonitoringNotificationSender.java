 ...
 * This skips monitoring in some router modules.
 * 
 * FIXME : Note, this is a duplicate of org.petalslink.dsb.kernel.pubsubmonitoring.service.MonitoringNotificationSender
 * 
 * @author chamerling
 * 
 */
public class MonitoringNotificationSender extends DSBNotificationSender {
    ...
    protected String getProducerAddress() {
        return "dsb://BSMMonitoringNotifcationSender";
    }
